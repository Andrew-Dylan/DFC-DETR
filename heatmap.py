    ...
    def __call__(self, img_path, save_path):
        ...
        if os.path.isdir(img_path):
            ...
            for img_path_ in os.listdir(img_path):
                full_path = os.path.join(img_path, img_path_)
                if os.path.isfile(full_path) and os.path.splitext(img_path_)[1].lower() in valid_exts:
                    self.process(full_path, f'{save_path}/{img_path_}')
        else:
...
if __name__ == '__main__':
    ...
    model(r'your-dataset', 'your-save-path')
